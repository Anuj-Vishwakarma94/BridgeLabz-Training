//Created class Named CalendarDisplay
...
public class CalendarDisplay{
   public static void main(String[]args){
    ...
    //display calendar
    displayCalendar(monthName,month,year,daysInMonth,firstDay);
   }
   ...
   public static void displayCalendar(String monthName,int month,int year,int daysInMonth,int firstDay){
