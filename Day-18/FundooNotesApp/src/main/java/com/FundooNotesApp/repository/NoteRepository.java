...
public interface NoteRepository extends JpaRepository<Note, Long> {
    ...
    // --- Reminder: find all notes whose reminder is due and not yet sent ---
    @Query("SELECT n FROM Note n WHERE n.reminderAt IS NOT NULL " +
           "AND n.reminderAt <= :now AND n.reminderSent = false")
